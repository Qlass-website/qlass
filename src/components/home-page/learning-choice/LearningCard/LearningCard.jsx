  ...
  return (
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3">
      <div className="flex flex-col items-center space-y-4 py-6 text-center">
        <img src="/whyLearning1.png"  className="w-32"/>
        <h1 className="font-bold text-white">Mastery (CBSE 8th class)</h1>
        <p className="font-light text-sm md:text-md text-gray-200">
      ...
      <div className="flex flex-col items-center space-y-4 py-6 text-center">
      <img src="/whyLearning2.png"  className="w-32"/>
      ...
      <div className="flex flex-col items-center space-y-4 py-6 text-center">
        <img src="/whyLearning3.png"  className="w-32"/>
