      ...
      <div className="w-full bg-indigo-800 pl-20 pr-6 pt-12 max-md:max-w-full max-md:px-5">
        <div className="max-md: flex gap-5 max-md:flex-col max-md:gap-0">
          <div className="flex w-[44%] flex-col max-md:ml-0 max-md:w-full">
            <div className="z-10 my-auto self-stretch text-white space-y-4 max-md:mt-10 max-md:max-w-full">
              <span className="font-medium text-4xl">
                ...
                <ul className="list-disc pl-5 text-gray-200 space-y-2">
                    ...
                    <li>Your teachers becomes the best as do what you want them to do rigorously. No more administrative stuffs.</li>
                    <li>Have your AI friend to assist you in all crisis pieces.</li>
                    <li>Be it Academics, Marketing , Referrals or Parent Communication (Leave no room for manual error)</li>
                </ul>
            </div>
          </div>
